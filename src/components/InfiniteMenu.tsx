...
function createProgram(gl: WebGL2RenderingContext, shaderSources: string[], transformFeedbackVaryings?: string[], attribLocations?: { [key: string]: number }) {
...
class InfiniteGridMenu {
    ...
    constructor(canvas: HTMLCanvasElement, items: MenuItem[], onActiveItemChange?: (index: number) => void, onMovementChange?: (isMoving: boolean) => void, onInit?: ((menu: InfiniteGridMenu) => void) | null) {
        this.canvas = canvas;
        this.items = items || [];
